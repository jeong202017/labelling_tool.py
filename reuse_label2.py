...
def roi_annotation(image_folder, output_folder):
    ...
    for root, _, files in os.walk(image_folder):
        for file_name in files:
            ...
            prev_roi = None
            prev_roi_path = os.path.join(output_folder, f"prev_roi_{file_name}.json")
            if os.path.exists(prev_roi_path):
                with open(prev_roi_path, 'r') as f:
